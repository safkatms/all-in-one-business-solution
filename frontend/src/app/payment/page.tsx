          ...
          <div className="bg-white m-10 min-w-96 shadow-2xl rounded-lg ring-offset-2 ring-2 border">
            ...
            >
              ...
              <div className="text-center">
                <button
                  type="submit"
                  className="bg-customTeal  text-white font-bold py-2 px-3 rounded focus:outline-none focus:shadow-outline mr-2 w-full sm:w-auto transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300"
                >
                  Pay
                </button>
              </div>
