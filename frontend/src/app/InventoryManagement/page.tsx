                      ...
                      <tbody className="text-gray-700">
                        <tr key={product.productId}>
                          ...
                          <td className="px-4 py-2 flex justify-between">
                            <button
                              type="submit"
                              className="bg-customTeal hover:bg-customBlack2 text-white font-bold py-1 px-1 rounded focus:outline-none focus:shadow-outline mr-2 w-full sm:w-auto"
                            ...
                            <button
                              type="submit"
                              className="bg-red-600 hover:bg-red-500 text-white font-bold py-1 px-1 rounded focus:outline-none focus:shadow-outline w-full sm:w-auto"
