          ...
          <table className="min-w-full bg-white rounded-lg overflow-hidden text-xs">
            <thead className="bg-gray-600 text-white">
              <tr>
                ...
                <th className="px-1 py-2">Vendor Name</th>
                <th className="px-1 py-2">Vendor Contact</th>
                <th className="px-1 py-2">Vendor Email</th>
                <th className="px-1 py-2">Product Name</th>
                <th className="px-1 py-2">Product Quantity</th>
                <th className="px-1 py-2">Product Purchase Price</th>
                <th className="px-1 py-2">Purchase Total Price</th>
                <th className="px-1 py-2">Purchase Date</th>
            ...
            <tbody className="text-gray-700">
              {purchases.map((purchase) => (
                <tr key={purchase.purchaseId}>
                  <td className="px-1 py-2">{purchase.purchaseId}</td>
                  <td className="px-1 py-2">{purchase.vendorName}</td>
                  <td className="px-1 py-2">{purchase.vendorContact}</td>
                  <td className="px-1 py-2">{purchase.vendorEmail}</td>
                  <td className="px-1 py-2">{purchase.productName}</td>
                  <td className="px-1 py-2">{purchase.productQuantity}</td>
                  <td className="px-1 py-2">{purchase.productPurchasePrice}</td>
                  <td className="px-1 py-2">{purchase.purchaseTotalPrice}</td>
                  <td className="px-1 py-2">{purchase.purchaseDate}</td>
