...
exports.CheckProductMiddleware = void 0;
...
let CheckProductMiddleware = class CheckProductMiddleware {
    ...
    async use(req, res, next) {
        ...
        for (const item of items) {
            ...
            if (product.productQuantity < item.quantity) {
                throw new common_1.BadRequestException(`Not enough quantity for product ${product.productName || item.productId}.`);
            }
        }
        next();
    }
};
exports.CheckProductMiddleware = CheckProductMiddleware;
exports.CheckProductMiddleware = CheckProductMiddleware = __decorate([
