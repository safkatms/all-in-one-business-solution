...
exports.config = {
    ...
    username: 'postgres',
    password: '123',
    entities: [user_entity_1.User, package_entity_1.Package, employee_entity_1.Employee, payroll_entity_1.Payroll, inventory_management_entity_1.InventoryManagement, purchase_management_entity_1.PurchaseManagement, customer_entity_1.Customer],
    synchronize: true,
};
